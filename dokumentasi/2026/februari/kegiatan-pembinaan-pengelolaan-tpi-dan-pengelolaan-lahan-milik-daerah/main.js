...
const REPORT_URL = 'https://dinasperikanansitubondo.com/dokumentasi/2026/februari/kegiatan-pembinaan-pengelolaan-tpi-dan-pengelolaan-lahan-milik-daerah/';
...
function shareToWhatsApp() {
    ...
    const text = encodeURIComponent('Dinas Peternakan & Perikanan Situbondo - Pembinaan Pengelolaan TPI dan Pengelolaan Lahan Milik Daerah. Simak selengkapnya:');
...
function generateDocumentId() {
    ...
    return `TPI-${day}${month}${year}-${random}`;
}
...
// ========= GENERATE PDF REPORT (SESUAI LAPORAN KEGIATAN.pdf) =========
function generatePDFReport(namaPelapor, nipPelapor) {
    ...
    let rawTitle = titleElement ? titleElement.innerText.trim() : "PEMBINAAN PENGELOLAAN TPI DAN PENGELOLAAN LAHAN MILIK DAERAH BIDANG PEMBERDAYAAN NELAYAN";
    ...
    // Konten laporan sesuai dengan LAPORAN KEGIATAN.pdf
    const pdfContent = `
    <div style="font-family: 'Times New Roman', Times, serif; line-height: 1.5; color: #333; padding: 0; display: flex; flex-direction: column; min-height: 100%;">
        ...
        <div style="text-align: center; margin-bottom: 25px;">
            ...
            <h1 style="font-size: 16px; font-weight: bold; text-decoration: underline; color: #1e3a8a; margin-bottom: 5px;">
                PEMBINAAN PENGELOLAAN TPI DAN PENGELOLAAN LAHAN MILIK DAERAH
            </h1>
            <h2 style="font-size: 15px; font-weight: bold; color: #1e3a8a; margin-top: 0;">BIDANG PEMBERDAYAAN NELAYAN</h2>
            <p style="font-size: 12px; margin-top: 5px;">DINAS PETERNAKAN DAN PERIKANAN KABUPATEN SITUBONDO</p>
        </div>
        
        <div style="margin-bottom: 25px; flex: 1;">
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">A. DASAR KEGIATAN</h4>
            <p style="text-align:justify; margin-bottom:15px; font-size:12px; text-indent:30px;">
                Kegiatan ini dilaksanakan sebagai bagian dari pelaksanaan tugas dan fungsi Bidang Pemberdayaan Nelayan dalam rangka peningkatan tata kelola Tempat Pelelangan Ikan (TPI) serta optimalisasi pengelolaan lahan milik daerah guna mendukung peningkatan Pendapatan Asli Daerah (PAD) Kabupaten Situbondo.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">B. WAKTU DAN TEMPAT</h4>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Hari, Tanggal : Rabu, 18 Februari 2026</li>
                <li>Tempat       : Aula Dinas Peternakan dan Perikanan Kabupaten Situbondo</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">C. PIMPINAN KEGIATAN</h4>
            <p style="text-align:justify; font-size:12px; margin-bottom:15px;">
                Kegiatan pembinaan dipimpin oleh Kepala Bidang Pemberdayaan Nelayan Dinas Peternakan dan Perikanan Kabupaten Situbondo, Sugeng Purwo Priyadi, S.E., M.M., serta diikuti oleh staf Bidang Pemberdayaan Nelayan.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">D. PESERTA / UNDANGAN</h4>
            <p style="font-size:12px; margin-bottom:10px;">Kegiatan ini dihadiri oleh para pengelola:</p>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>TPI Pandean</li>
                <li>TPI Panarukan</li>
                <li>TPI Pondok Mimbo</li>
                <li>TPI Blitok</li>
                <li>TPI Kalianget</li>
                <li>TPI Banyuglugur</li>
                <li>TPI Peleyan</li>
                <li>Tambak Garam Tanjung Panarukan</li>
                <li>Tambak Garam Tanjung Kamal</li>
                <li>Tambak Garam Tanjung Pecinan</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">E. MAKSUD DAN TUJUAN</h4>
            <p style="text-align:justify; font-size:12px; margin-bottom:10px;">Kegiatan pembinaan ini bertujuan untuk:</p>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Meningkatkan pemahaman pengelola TPI dan lahan milik daerah mengenai pentingnya optimalisasi pengelolaan aset daerah.</li>
                <li>Mendorong peningkatan kontribusi sektor perikanan dan pengelolaan lahan terhadap Pendapatan Asli Daerah.</li>
                <li>Menyelaraskan tata kelola retribusi daerah agar berjalan sesuai dengan ketentuan peraturan perundang-undangan.</li>
                <li>Memperkuat komitmen bersama dalam mendukung pembangunan daerah melalui sektor kelautan dan perikanan.</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">F. MATERI YANG DISAMPAIKAN</h4>
            <p style="font-weight:bold; font-size:12px; margin-bottom:5px;">1. Pentingnya Peningkatan Pendapatan Asli Daerah (PAD)</p>
            <p style="text-align:justify; font-size:12px; margin-bottom:10px;">
                Disampaikan bahwa peningkatan PAD merupakan salah satu pilar utama dalam mendukung kemandirian fiskal daerah. Optimalisasi penerimaan dari sektor perikanan, khususnya melalui pengelolaan TPI dan lahan milik daerah, menjadi bagian strategis dalam pembiayaan pembangunan infrastruktur, peningkatan layanan publik, serta penguatan kesejahteraan masyarakat pesisir. Pengelolaan yang profesional, transparan, dan akuntabel akan berdampak langsung pada peningkatan kepercayaan publik serta keberlanjutan pembangunan daerah.
            </p>
            <p style="font-weight:bold; font-size:12px; margin-bottom:5px;">2. Manfaat Retribusi Daerah</p>
            <p style="text-align:justify; font-size:12px; margin-bottom:10px;">
                Retribusi daerah dipaparkan sebagai instrumen penting dalam mendukung pembiayaan operasional dan pengembangan fasilitas TPI serta pemeliharaan aset daerah. Manfaat retribusi daerah antara lain:
            </p>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Mendukung perbaikan sarana dan prasarana TPI.</li>
                <li>Menjamin keberlanjutan pelayanan kepada nelayan dan pelaku usaha perikanan.</li>
                <li>Meningkatkan kualitas tata kelola pengelolaan aset daerah.</li>
                <li>Berkontribusi terhadap pembangunan ekonomi daerah secara berkelanjutan.</li>
            </ul>
            <p style="text-align:justify; font-size:12px;">Ditekankan pula bahwa pemungutan retribusi harus dilaksanakan secara tertib administrasi, sesuai regulasi, serta dilaporkan secara transparan.</p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">G. HASIL DAN TINDAK LANJUT</h4>
            <p style="text-align:justify; font-size:12px; margin-bottom:10px;">Hasil dari kegiatan pembinaan ini antara lain:</p>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Meningkatnya pemahaman pengelola TPI dan lahan milik daerah terkait optimalisasi pengelolaan aset dan retribusi.</li>
                <li>Adanya komitmen bersama untuk meningkatkan disiplin administrasi dan pelaporan.</li>
                <li>Kesepakatan untuk memperkuat koordinasi antara pengelola lapangan dengan Bidang Pemberdayaan Nelayan.</li>
            </ul>
            <p style="text-align:justify; font-size:12px;">
                Sebagai tindak lanjut, akan dilakukan monitoring dan evaluasi secara berkala terhadap pelaksanaan pengelolaan TPI dan lahan milik daerah guna memastikan peningkatan kontribusi terhadap Pendapatan Asli Daerah.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">H. PENUTUP</h4>
            <p style="text-align:justify; font-size:12px;">
                Kegiatan pembinaan berjalan dengan tertib dan lancar. Diharapkan melalui kegiatan ini, pengelolaan Tempat Pelelangan Ikan serta lahan milik daerah di Kabupaten Situbondo semakin optimal, profesional, dan berkontribusi nyata terhadap pembangunan daerah. Demikian laporan kegiatan ini dibuat untuk dipergunakan sebagaimana mestinya.
            </p>
        </div>
