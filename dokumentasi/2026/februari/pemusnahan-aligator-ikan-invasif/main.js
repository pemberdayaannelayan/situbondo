...
const REPORT_URL = 'https://dinasperikanansitubondo.com/dokumentasi/2026/februari/pemusnahan-aligator-ikan-invasif/';
...
function shareToWhatsApp() {
    ...
    const text = encodeURIComponent('Dinas Peternakan & Perikanan Situbondo musnahkan ikan aligator invasif. Simak selengkapnya:');
...
function generateDocumentId() {
    ...
    return `ALT-${day}${month}${year}-${random}`;
}
...
function generatePDFReport(namaPelapor, nipPelapor) {
    ...
    let rawTitle = titleElement ? titleElement.innerText.trim() : "Pemusnahan Ikan Aligator Invasif di Situbondo";
    ...
    <div style="font-family: 'Times New Roman', Times, serif; line-height: 1.5; color: #333; padding: 0; display: flex; flex-direction: column; min-height: 100%;">
        ...
        <div style="margin-bottom: 25px; flex: 1;">
            ...
            <p style="text-align:justify; margin-bottom:15px; font-size:12px; text-indent:30px;">
                Kegiatan ini dilaksanakan berdasarkan laporan masyarakat tentang keberadaan ikan aligator (Atractosteus spatula) di perairan Situbondo. Tindakan pemusnahan dipimpin oleh Kepala Bidang Pemberdayaan Nelayan, Sugeng Purwo Priyanto, S.E., M.M., dengan pendampingan dari Kristian Hadi Surya S, S.Pi selaku Pengawas Perikanan sesuai Surat Tugas Nomor <strong>B. 239/PSDKPLan.4/KP.440/II/2026</strong> dari Kepala Pangkalan Pengawasan Sumber Daya Kelautan dan Perikanan Beno.
            </p>
            ...
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Hari/Tanggal : Kamis, 5 Februari 2026</li>
                <li>Waktu        : 09.00 WIB – selesai</li>
                <li>Tempat       : Dinas Peternakan & Perikanan Situbondo</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">III. PERSONEL YANG TERLIBAT</h4>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Penanggung Jawab : Sugeng Purwo Priyanto, S.E., M.M. (Kabid Pemberdayaan Nelayan)</li>
                <li>Pengawas : Kristian Hadi Surya S, S.Pi</li>
                <li>Tim Teknis : Staf Bidang Pemberdayaan Nelayan</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">IV. PROSEDUR PEMUSNAHAN</h4>
            <ol style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Identifikasi dan verifikasi jenis ikan</li>
                <li>Dokumentasi untuk pelaporan</li>
                <li>Proses pemusnahan secara manusiawi sesuai standar</li>
                <li>Penguburan bangkai dengan metode aman dan higienis</li>
            ...
            <p style="text-align:justify; font-size:12px; text-indent:30px; margin-bottom:15px;">
                Kegiatan berjalan lancar dan sesuai prosedur. Ikan aligator berhasil dimusnahkan dan dikubur di lokasi yang aman. Masyarakat sekitar turut diedukasi tentang bahaya spesies asing invasif dan pentingnya melaporkan temuan serupa. Partisipasi aktif masyarakat dalam melaporkan keberadaan ikan ini patut diapresiasi.
            </p>
        </div>
