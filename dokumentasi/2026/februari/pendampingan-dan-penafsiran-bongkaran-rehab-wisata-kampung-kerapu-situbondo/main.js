...
const REPORT_URL = 'https://dinasperikanansitubondo.com/dokumentasi/2026/februari/pendampingan-dan-penafsiran-bongkaran-rehab-wisata-kampung-kerapu-situbondo/';
...
function shareToWhatsApp() {
    ...
    const text = encodeURIComponent('Dinas Peternakan & Perikanan Situbondo - Pendampingan Penafsiran Bongkaran Rehab Kampung Kerapu. Simak selengkapnya:');
    ...
    try {
        ...
        for (let row = 0; row < moduleCount; row++) {
            for (let col = 0; col < moduleCount; col++) {
                ctx.fillStyle = qr.isDark(row, col) ? '#0b4f6c' : '#ffffff';
...
function generateDocumentId() {
    ...
    return `KERAPU-${day}${month}${year}-${random}`;
}
...
// ========= GENERATE PDF REPORT (SESUAI TOPIK BARU) =========
function generatePDFReport(namaPelapor, nipPelapor) {
    ...
    let rawTitle = titleElement ? titleElement.innerText.trim() : "PENDAMPINGAN DAN PENAFSIRAN BONGKARAN REHAB WISATA KAMPUNG KERAPU SITUBONDO – BIDANG PEMBERDAYAAN NELAYAN";
    ...
    // Konten laporan sesuai dengan topik Pendampingan Penafsiran Bongkaran Rehab Kampung Kerapu
    const pdfContent = `
    <div style="font-family: 'Times New Roman', Times, serif; line-height: 1.5; color: #333; padding: 0; display: flex; flex-direction: column; min-height: 100%;">
        ...
        <div style="text-align: center; margin-bottom: 25px;">
            ...
            <h1 style="font-size: 16px; font-weight: bold; text-decoration: underline; color: #0b4f6c; margin-bottom: 5px;">
                PENDAMPINGAN DAN PENAFSIRAN BONGKARAN REHAB WISATA KAMPUNG KERAPU SITUBONDO
            </h1>
            <h2 style="font-size: 15px; font-weight: bold; color: #0b4f6c; margin-top: 0;">BIDANG PEMBERDAYAAN NELAYAN</h2>
        ...
        <div style="margin-bottom: 25px; flex: 1;">
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">A. DASAR KEGIATAN</h4>
            <p style="text-align:justify; margin-bottom:15px; font-size:12px; text-indent:30px;">
                Kegiatan ini dilaksanakan sebagai bagian dari pelaksanaan tugas dan fungsi Bidang Pemberdayaan Nelayan dalam rangka mendukung tertib administrasi pengelolaan aset daerah serta memastikan kesesuaian kondisi fisik sarana prasarana perikanan tangkap di lapangan, khususnya di kawasan Kampung Kerapu Situbondo.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">B. WAKTU DAN TEMPAT</h4>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Hari, Tanggal : Selasa, 24 Februari 2026</li>
                <li>Tempat       : Kawasan Kampung Kerapu, Situbondo</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">C. PIMPINAN DAN TIM PELAKSANA</h4>
            <p style="text-align:justify; font-size:12px; margin-bottom:15px;">
                Kegiatan pendampingan dipimpin oleh Koordinator Bidang Pemberdayaan Nelayan, Feri Zainur Rofiq, S.Pi., M.Si., bersama staf Bidang Pemberdayaan Nelayan. Tim juga melibatkan Tim Aset dari BKAD Kabupaten Situbondo serta staf teknis dari Dinas PUPP Kabupaten Situbondo.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">D. RUANG LINGKUP REHABILITASI</h4>
            <p style="font-size:12px; margin-bottom:10px;">Rehabilitasi di Kampung Kerapu Situbondo meliputi beberapa komponen utama, yaitu:</p>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Rehab tangkis</li>
                <li>Rehab dermaga/joging track</li>
                <li>Rehab membran</li>
            </ul>
            <p style="font-size:12px;">Ketiga komponen tersebut merupakan bagian penting dalam mendukung aktivitas perikanan tangkap, khususnya sebagai fasilitas penunjang operasional dan lingkungan kawasan pesisir.</p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">E. HASIL IDENTIFIKASI DAN PENAFSIRAN LAPANGAN</h4>
            <p style="text-align:justify; font-size:12px; margin-bottom:10px;">Berdasarkan hasil pengecekan langsung di lapangan bersama tim teknis, diperoleh data tingkat kerusakan sebagai berikut:</p>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Kerusakan tangkis mencapai kurang lebih 40%.</li>
                <li>Kerusakan dermaga/joging track mencapai kurang lebih 20%, dengan jumlah kayu papan yang mengalami kerusakan sebanyak sekitar 600 (enam ratus) biji.</li>
                <li>Kerusakan membran mencapai kurang lebih 70%.</li>
            </ul>
            <p style="text-align:justify; font-size:12px;">
                Data ini menjadi dasar dalam proses penafsiran bongkaran serta bahan pertimbangan dalam perencanaan tindak lanjut rehabilitasi ke depan. Identifikasi dilakukan secara menyeluruh untuk memastikan kesesuaian antara kondisi riil dan dokumen perencanaan.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">F. KOMITMEN TERHADAP TATA KELOLA YANG AKUNTABEL</h4>
            <p style="text-align:justify; font-size:12px;">
                Pendampingan yang dilakukan oleh Bidang Pemberdayaan Nelayan menunjukkan komitmen Dinas Peternakan dan Perikanan Kabupaten Situbondo dalam mendukung tata kelola pemerintahan yang transparan, akuntabel, dan profesional. Pengelolaan sarana dan prasarana perikanan tangkap tidak hanya berfokus pada pembangunan fisik, tetapi juga pada ketertiban administrasi serta keberlanjutan pemanfaatannya bagi masyarakat nelayan.
            </p>
            <p style="text-align:justify; font-size:12px;">
                Dengan adanya koordinasi yang baik antara BKAD, Dinas PUPP, dan Dinas Peternakan dan Perikanan, diharapkan seluruh proses rehabilitasi dan pengelolaan aset daerah dapat berjalan efektif serta memberikan manfaat optimal bagi pengembangan sektor perikanan tangkap di Kabupaten Situbondo.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#0b4f6c; border-bottom: 1px solid #ccc; padding-bottom: 5px;">G. PENUTUP</h4>
            <p style="text-align:justify; font-size:12px;">
                Kegiatan pendampingan berjalan dengan tertib dan lancar. Ke depan, Bidang Pemberdayaan Nelayan akan terus berperan aktif dalam setiap tahapan pembangunan dan pemeliharaan sarana prasarana perikanan, sebagai bagian dari upaya meningkatkan kesejahteraan nelayan dan memperkuat ekonomi pesisir daerah. Demikian laporan kegiatan ini dibuat untuk dipergunakan sebagaimana mestinya.
            </p>
        </div>
