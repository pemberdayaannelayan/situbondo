...
const REPORT_URL = 'https://www.dinasperikanansitubondo.com/dokumentasi/2025/november/pelatihan-teknologi-penangkapan-ikan-besuki/';
...
function shareToWhatsApp() {
    ...
    const text = encodeURIComponent('Dinas Peternakan & Perikanan Situbondo mengadakan Pelatihan Teknologi Penangkapan Ikan di Besuki, 10 November 2025. Simak selengkapnya:');
...
function generateDocumentId() {
    ...
    return `PLT-${day}${month}${year}-${random}`;
}
...
function generatePDFReport(namaPelapor, nipPelapor) {
    ...
    let rawTitle = titleElement ? titleElement.innerText.trim() : "PELATIHAN TEKNOLOGI PENANGKAPAN IKAN DAN PERAWATAN JARING UNTUK NELAYAN SITUBONDO";
    ...
    <div style="font-family: 'Times New Roman', Times, serif; line-height: 1.5; color: #333; padding: 0; display: flex; flex-direction: column; min-height: 100%;">
        ...
        <div style="text-align: center; margin-bottom: 25px;">
            ...
            <h2 style="font-size: 15px; font-weight: bold; color: #1e3a8a; margin-top: 0;">KECAMATAN BESUKI, KABUPATEN SITUBONDO</h2>
        </div>
        
        <div style="margin-bottom: 25px; flex: 1;">
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">I. LATAR BELAKANG</h4>
            <p style="text-align:justify; margin-bottom:15px; font-size:12px; text-indent:30px;">
                Dalam upaya meningkatkan kapasitas dan keterampilan nelayan tradisional di Kabupaten Situbondo, Dinas Peternakan dan Perikanan Kabupaten Situbondo bekerjasama dengan UPT. PTKP3 Probolinggo menyelenggarakan kegiatan Pelatihan Teknologi Penangkapan Ikan dengan fokus utama pada perawatan jaring ikan. Kegiatan ini dilaksanakan pada tanggal 10 November 2025 di Kecamatan Besuki, Kabupaten Situbondo.
            </p>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">II. TUJUAN KEGIATAN</h4>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Meningkatkan pengetahuan dan keterampilan nelayan dalam merawat dan memperbaiki jaring ikan</li>
                <li>Memperkenalkan teknologi penangkapan ikan yang ramah lingkungan</li>
                <li>Meningkatkan keselamatan dan kesehatan kerja nelayan</li>
                <li>Meningkatkan produktivitas dan hasil tangkapan nelayan</li>
                <li>Memperkuat sinergi antara pemerintah, lembaga teknis, dan masyarakat nelayan</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">III. PELAKSANAAN KEGIATAN</h4>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Hari/Tanggal : Senin, 10 November 2025</li>
                <li>Waktu        : 08.00 - 15.00 WIB</li>
                <li>Tempat       : Kecamatan Besuki, Kabupaten Situbondo</li>
                <li>Jumlah Peserta : 25 Nelayan Tradisional</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">IV. MATERI PELATIHAN</h4>
            <ul style="font-size:12px; line-height:1.6; padding-left: 20px;">
                <li>Perawatan Jaring Ikan (teknik perawatan, penyimpanan, dan perbaikan)</li>
                <li>Penangkapan Ikan Ramah Lingkungan</li>
                <li>Keselamatan dan Kesehatan Kerja Nelayan</li>
                <li>Teknologi Jaring Modern dan Material</li>
            </ul>
            
            <h4 style="font-size:13px; font-weight:bold; margin-bottom:10px; color:#1e3a8a; border-bottom: 1px solid #ccc; padding-bottom: 5px;">V. HASIL KEGIATAN</h4>
            <p style="text-align:justify; font-size:12px; text-indent:30px; margin-bottom:15px;">
                Kegiatan pelatihan berlangsung dengan lancar dan diikuti dengan antusias oleh seluruh peserta. Para nelayan memperoleh pengetahuan dan keterampilan baru dalam merawat jaring ikan yang dapat memperpanjang usia pakai dan meningkatkan efisiensi penangkapan. Selain itu, peserta juga mendapatkan bantuan langsung berupa jaring gillnet baru untuk diterapkan dalam kegiatan penangkapan ikan.
            </p>
            <p style="text-align:justify; font-size:12px; text-indent:30px;">
                Narasumber dari UPT. PTKP3 Probolinggo, Bapak Nanang Qoshim, memberikan materi dengan metode partisipatif. Kegiatan juga dihadiri oleh Kepala Dinas Peternakan dan Perikanan, Drs. Achmad Djunaidi, M.Si, beserta jajaran. Sesi kuis interaktif dengan doorprize jaring gillnet menambah semangat peserta.
            </p>
        </div>
