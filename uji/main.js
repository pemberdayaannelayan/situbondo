...
// REVISI LOGIN: GANTI METODE PERIODE TERBALIK MENJADI USERNAME DAN PASSWORD
// =====================================================
...
function setupEventListeners() {
    ...
    // Logout - REVISI: Tambahkan reset currentUser
        ...
        logoutBtn.addEventListener('click', () => {
            if(confirm('Apakah Anda yakin ingin keluar? Sistem akan mengunduh data backup secara otomatis.')) {
                ...
                setTimeout(() => {
                    ...
                    sessionStorage.removeItem('simata_user');
                    currentUser = null;
