...
function safeGenerateIDCard(id) {
    // Gunakan fungsi generateIDCard yang ada di functions.js
    if (typeof window.generateIDCard === 'function') {
        window.generateIDCard(id);
    } else {
        showNotification('Fungsi generateIDCard tidak tersedia. Pastikan functions.js sudah dimuat.', 'error');
    }
}
...
// Fungsi yang akan digunakan dari functions.js (dideklarasikan di sini untuk referensi)
window.generateTabelPdf = function() {
    console.log('generateTabelPdf dipanggil dari functions.js');
};

window.generateFilteredPdf = function() {
    console.log('generateFilteredPdf dipanggil dari functions.js');
};

window.printData = function() {
    console.log('printData dipanggil dari functions.js');
};

window.backupData = function() {
    console.log('backupData dipanggil dari functions.js');
};

window.restoreData = function() {
    console.log('restoreData dipanggil dari functions.js');
};

window.handleReloadRepo = function() {
    console.log('handleReloadRepo dipanggil dari functions.js');
};

window.downloadSinglePdf = function(id) {
    console.log('downloadSinglePdf dipanggil dari functions.js dengan id:', id);
};

window.verifyKIN = function(input) {
    console.log('verifyKIN dipanggil dari functions.js dengan input:', input);
    return { success: false, message: "Fungsi verifyKIN belum dimuat dari functions.js" };
};

window.displayVerifyResult = function(result) {
    console.log('displayVerifyResult dipanggil dari functions.js dengan result:', result);
};

window.setVerifyExample = function(type) {
    console.log('setVerifyExample dipanggil dari functions.js dengan type:', type);
};

window.verifyKINAndShow = function(input) {
    console.log('verifyKINAndShow dipanggil dari functions.js dengan input:', input);
};

window.resetVerifyForm = function() {
    console.log('resetVerifyForm dipanggil dari functions.js');
};
